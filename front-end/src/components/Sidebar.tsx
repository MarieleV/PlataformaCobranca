  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200/60 flex flex-col h-full flex-shrink-0 font-sans select-none">
      ...
      <div className="px-6 py-6 border-b border-slate-100 flex items-center gap-3">
        <div className="w-9 h-9 rounded-xl bg-blue-600 text-white font-mono font-bold text-sm flex items-center justify-center shadow-sm shadow-blue-600/20">
          CA
        </div>
        <div>
      ...
      <div className="p-4 border-t border-slate-100 bg-slate-50/50">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-9 h-9 rounded-full bg-blue-100 text-blue-700 font-bold text-xs flex items-center justify-center flex-shrink-0 shadow-sm">
            MV
          </div>
