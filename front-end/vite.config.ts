...
// Configuração padrão local (substitui o arquivo .json excluído)
const siteConfiguration: FigmaSiteConfiguration = {
  title: "Plataforma de Cobrança Automatizada",
  description: "Sistema Fintech de Gestão e Régua de Cobrança",
  language: "pt-BR",
  robots: { index: true },
}
